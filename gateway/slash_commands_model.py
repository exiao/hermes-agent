...
class GatewayModelCommandsMixin:
    ...
    async def _handle_fast_command(self, event: MessageEvent) -> Optional[str]:
        ...
        try:
            ...
            # Keep the availability check useful in incomplete setups while still honoring a
            # persisted/in-memory session model before falling back to the global default.
