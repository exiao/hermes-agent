...
class AIAgent:
    ...
    def __init__(
        ...
        # config.yaml under prompt_caching.cache_ttl; unknown values keep the
        # default from agent/prompt_caching.py's CACHE_TTL constant.
        ...
        try:
            ...
            _ttl = _pc_cfg.get("cache_ttl", CACHE_TTL)
            if _ttl in ("5m", "1h"):
