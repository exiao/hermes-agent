    ...
    def _format_turn_completion_explanation(
        ...
        if reason == "session_persistence_failed":
            ...
            return (
                ...
                "Hermes process; a drive that is out of free space or bad "
                "state.db permissions can also cause it. Check the state "
                "database health (`hermes doctor`), then send your message "
                "again."
            )
