...
def try_activate_fallback(agent, reason: "FailoverReason | None" = None) -> bool:
    ...
    try:
        ...
        # FORK: `agent.announce_fallback` opts into seeing the switch LIVE
        # instead of only buffered; _announce_or_buffer_fallback falls back to
        # _buffer_status when unset, so upstream's behavior is unchanged.
        getattr(agent, "_announce_or_buffer_fallback", agent._buffer_status)(notice)
