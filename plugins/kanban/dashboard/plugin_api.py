...
# The manual drag-drop status move lives in the shared kanban_db layer so the
# dashboard plugin and the standalone kanban viewer use one sanctioned code
# path. Keep the private alias for this module's call sites (and tests that
# import it by name).
_set_status_direct = kanban_db.set_status_direct
