...
DEFAULT_CONFIG = {
    ...
    "agent": {
        ...
        # prompt. Tool schemas still ship; narrow toolsets separately.
        ...
        # Surfaces subtracted from verify_on_stop; subtraction never enables a
        # surface whose resolved verification setting is already off.
    ...
    "terminal": {
        ...
        # Seconds a remote sandbox may idle before its provider reaps it. 0 = disabled.
    ...
    "delegation": {
        ...
        # "fallback_providers". Only consulted when "provider" is set: a pin
        # deliberately does NOT inherit the parent chain (#80450), so without
        # this a single 429 ends the run. Empty (default) = fail loudly.
        "fallback_providers": [],
