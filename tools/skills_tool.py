...
def _find_all_skills(*, skip_disabled: bool = False) -> List[Dict[str, Any]]:
    ...
    for scan_dir in dirs_to_scan:
        ...
        for skill_md in _iter:
            # Exclusion is checked on the path RELATIVE to scan_dir: an absolute
            # parent component (e.g. a user dir literally named "node_modules")
            # must not disqualify an otherwise valid skill.
            if any(
